...
wonderchatWrapper.style.bottom = "20px";
wonderchatWrapper.style.right = "20px";
wonderchatWrapper.style.width = "50px";
wonderchatWrapper.style.height = "50px";
...
console.log('iframeUrl 2', iframeUrl)
iframe.setAttribute("src", iframeUrl);
...
waitForElm("#wonderchat").then((elm) => {
  ...
  window.addEventListener(
    ...
    function (e) {
      console.log('event', e)
      const address = removeHttp(wonderchatAddress)
